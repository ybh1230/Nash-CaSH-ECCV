...
class WanVideoToVideoPipeline(DiffusionPipeline, WanLoraLoaderMixin):
    ...
    def __call__(
        ...
        guide_steps = range(0, all_steps, cache_steps)
            ...
            for i, t in enumerate(timesteps):
                ...
                if i in guide_steps:
                    ...
                    if cached_attn_outputs is not None:
                        del cached_attn_outputs
                        cached_attn_outputs = None
                else:
                    cache_cross_ouput = False

                noise_pred, new_attn_outputs = self.transformer(
                    ...
                    return_dict=False,
                    steps=i,
                    cache_cross_ouput=cache_cross_ouput,
                    reuse_cross_output=cached_attn_outputs,
                    cond=True
                )
